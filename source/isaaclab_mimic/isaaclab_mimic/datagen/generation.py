...
from isaaclab_mimic.datagen.data_generator_scheduled import DataGeneratorScheduled
...
async def run_data_generator(
    ...
    data_generator: DataGenerator | DataGeneratorRefactored | DataGeneratorScheduled,
